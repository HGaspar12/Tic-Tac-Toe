...
public class JFrameJogo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setBackground(new java.awt.Color(1, 7, 0));
        jTextArea1.setColumns(20);
        jTextArea1.setFont(new java.awt.Font("Varsity Regular", 1, 12)); // NOI18N
        jTextArea1.setForeground(new java.awt.Color(90, 182, 0));
        jTextArea1.setRows(5);
        jTextArea1.setText("  \t\t\tJogo da Velha #");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jogador == false) {//Jogadas do jogador 1
            jButton1.setText(jogovelha.jog1.getSimbolo()); //Mudar campo de jogo com o símbolo do jogador1
            ...
            jButton1.setText(jogovelha.jog2.getSimbolo()); //Mudar campo de jogo com o símbolo do Jogador 2
            jogovelha.VerificarGanhador(jButton1.getText(), jButton2.getText(), jButton3.getText(), jButton4.getText(), 
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (jogador == false) {
            jButton2.setText(jogovelha.jog1.getSimbolo());
            ...
            jButton2.setText(jogovelha.jog2.getSimbolo());
            jogovelha.VerificarGanhador(jButton1.getText(), jButton2.getText(), jButton3.getText(), jButton4.getText(), jButton5.getText(), jButton6.getText(), jButton7.getText(), jButton8.getText(), jButton9.getText(), jogador);
            jButton2.setEnabled(false);
            jogador = false;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (jogador == false) {
            jButton3.setText(jogovelha.jog1.getSimbolo());
            jogovelha.VerificarGanhador(jButton1.getText(), jButton2.getText(), jButton3.getText(), jButton4.getText(), jButton5.getText(), jButton6.getText(), jButton7.getText(), jButton8.getText(), jButton9.getText(), jogador);
            jButton3.setEnabled(false);
            jogador = true;
            jTextPaneVez.setText(jTextField2Jogador2.getText());
            ...
            jButton3.setText(jogovelha.jog2.getSimbolo());
            jogovelha.VerificarGanhador(jButton1.getText(), jButton2.getText(), jButton3.getText(), jButton4.getText(), jButton5.getText(), jButton6.getText(), jButton7.getText(), jButton8.getText(), jButton9.getText(), jogador);
            jButton3.setEnabled(false);
            jogador = false;
            jTextPaneVez.setText(jTextFieldJogador1.getText());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        if (jogador == false) {
            jButton4.setText(jogovelha.jog1.getSimbolo());
            jogovelha.VerificarGanhador(jButton1.getText(), jButton2.getText(), jButton3.getText(), jButton4.getText(), jButton5.getText(), jButton6.getText(), jButton7.getText(), jButton8.getText(), jButton9.getText(), jogador);
            jButton4.setEnabled(false);
            jogador = true;
            jTextPaneVez.setText(jTextField2Jogador2.getText());
            ...
            jButton4.setText(jogovelha.jog2.getSimbolo());
            jogovelha.VerificarGanhador(jButton1.getText(), jButton2.getText(), jButton3.getText(), jButton4.getText(), jButton5.getText(), jButton6.getText(), jButton7.getText(), jButton8.getText(), jButton9.getText(), jogador);
            jButton4.setEnabled(false);
            jogador = false;
            jTextPaneVez.setText(jTextFieldJogador1.getText());
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        if (jogador == false) {
            jButton5.setText(jogovelha.jog1.getSimbolo());
            jogovelha.VerificarGanhador(jButton1.getText(), jButton2.getText(), jButton3.getText(), jButton4.getText(), jButton5.getText(), jButton6.getText(), jButton7.getText(), jButton8.getText(), jButton9.getText(), jogador);
            jButton5.setEnabled(false);
            jogador = true;
            jTextPaneVez.setText(jTextField2Jogador2.getText());
            ...
            jButton5.setText(jogovelha.jog2.getSimbolo());
            jogovelha.VerificarGanhador(jButton1.getText(), jButton2.getText(), jButton3.getText(), jButton4.getText(), jButton5.getText(), jButton6.getText(), jButton7.getText(), jButton8.getText(), jButton9.getText(), jogador);
            jButton5.setEnabled(false);
            jogador = false;
            jTextPaneVez.setText(jTextFieldJogador1.getText());
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        if (jogador == false) {
            jButton6.setText(jogovelha.jog1.getSimbolo());
            jogovelha.VerificarGanhador(jButton1.getText(), jButton2.getText(), jButton3.getText(), jButton4.getText(), jButton5.getText(), jButton6.getText(), jButton7.getText(), jButton8.getText(), jButton9.getText(), jogador);
            jButton6.setEnabled(false);
            jogador = true;
            jTextPaneVez.setText(jTextField2Jogador2.getText());
            ...
            jButton6.setText(jogovelha.jog2.getSimbolo());
            jogovelha.VerificarGanhador(jButton1.getText(), jButton2.getText(), jButton3.getText(), jButton4.getText(), jButton5.getText(), jButton6.getText(), jButton7.getText(), jButton8.getText(), jButton9.getText(), jogador);
            jButton6.setEnabled(false);
            jogador = false;
            jTextPaneVez.setText(jTextFieldJogador1.getText());
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        if (jogador == false) {
            jButton7.setText(jogovelha.jog1.getSimbolo());
            jogovelha.VerificarGanhador(jButton1.getText(), jButton2.getText(), jButton3.getText(), jButton4.getText(), jButton5.getText(), jButton6.getText(), jButton7.getText(), jButton8.getText(), jButton9.getText(), jogador);
            jButton7.setEnabled(false);
            jogador = true;
            jTextPaneVez.setText(jTextField2Jogador2.getText());
            ...
            jButton7.setText(jogovelha.jog2.getSimbolo());
            jogovelha.VerificarGanhador(jButton1.getText(), jButton2.getText(), jButton3.getText(), jButton4.getText(), jButton5.getText(), jButton6.getText(), jButton7.getText(), jButton8.getText(), jButton9.getText(), jogador);
            jButton7.setEnabled(false);
            jogador = false;
            jTextPaneVez.setText(jTextFieldJogador1.getText());
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        if (jogador == false) {
            jButton8.setText(jogovelha.jog1.getSimbolo());
            jogovelha.VerificarGanhador(jButton1.getText(), jButton2.getText(), jButton3.getText(), jButton4.getText(), jButton5.getText(), jButton6.getText(), jButton7.getText(), jButton8.getText(), jButton9.getText(), jogador);
            jButton8.setEnabled(false);
            jogador = true;
            jTextPaneVez.setText(jTextField2Jogador2.getText());
            ...
            jButton8.setText(jogovelha.jog2.getSimbolo());
            jogovelha.VerificarGanhador(jButton1.getText(), jButton2.getText(), jButton3.getText(), jButton4.getText(), jButton5.getText(), jButton6.getText(), jButton7.getText(), jButton8.getText(), jButton9.getText(), jogador);
            jButton8.setEnabled(false);
            jogador = false;
            jTextPaneVez.setText(jTextFieldJogador1.getText());
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        if (jogador == false) {
            jButton9.setText(jogovelha.jog1.getSimbolo());
            jogovelha.VerificarGanhador(jButton1.getText(), jButton2.getText(), jButton3.getText(), jButton4.getText(), jButton5.getText(), jButton6.getText(), jButton7.getText(), jButton8.getText(), jButton9.getText(), jogador);
            jButton9.setEnabled(false);
            jogador = true;
            jTextPaneVez.setText(jTextField2Jogador2.getText());
            ...
            jButton9.setText(jogovelha.jog2.getSimbolo());
            jogovelha.VerificarGanhador(jButton1.getText(), jButton2.getText(), jButton3.getText(), jButton4.getText(), jButton5.getText(), jButton6.getText(), jButton7.getText(), jButton8.getText(), jButton9.getText(), jogador);
            jButton9.setEnabled(false);
            jogador = false;
            jTextPaneVez.setText(jTextFieldJogador1.getText());
